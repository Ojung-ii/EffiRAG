...
VARIANTS_CSV="champion_reconfirm,answer_surface_normalization,answer_type_aware_extraction,answer_cue_highlight,evidence_supported_verification"
N_SAMPLES="1000"
QA_ROOT="data/qa"
CORPUS_ROOT="/home/ojungii/HippoRAG2/dataset"
EFFIRAG_OUTPUT_ROOT="outputs/retrieval_metric_hotpot_2wiki_round_rerun_strict"
OUTPUT_ROOT="outputs/abgf_improvement_round"
...
usage() {
  cat <<'USAGE'
Usage: bash scripts/run_abgf_improvement_round.sh [options]
...
"${PYTHON_BIN}" scripts/abgf_improvement_round.py \
