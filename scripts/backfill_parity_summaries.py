...
def main() -> int:
    ...
    parser.add_argument(
        "--recomputed-json",
        type=str,
        default="/home/ojungii/EffiRAG/outputs/profiling/eval_parity/recomputed_all_summary.json",
    )
    parser.add_argument(
        "--sidecar-name",
        type=str,
    ...
    parser.add_argument(
        "--manifest-json",
        type=str,
        default="/home/ojungii/EffiRAG/outputs/profiling/eval_parity/parity_backfill_manifest.json",
    )
    parser.add_argument(
        "--report-md",
        type=str,
        default="/home/ojungii/EffiRAG/outputs/profiling/eval_parity/parity_backfill_delta_report.md",
    )
