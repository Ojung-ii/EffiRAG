...
DATASETS=(
  "2wikimultihopqa:data/qa/2wikimultihopqa.json:data/2wikimultihopqa_corpus.json"
  # "hotpotqa:data/qa/hotpotqa.json:data/hotpotqa_corpus.json"
  # "musique:data/qa/musique.json:data/musique_corpus.json"
  # "popqa:data/qa/popqa.json:data/popqa_corpus.json"
)
