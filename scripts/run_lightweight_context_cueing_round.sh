...
VARIANTS_CSV="champion_reconfirm,minimal_role_prefix,inline_source_role_hint,title_preserving_compact_render,light_separator_render,query_aware_soft_ordering"
N_SAMPLES="1000"
QA_ROOT="data/qa"
...
OUTPUT_ROOT="outputs/lightweight_context_cueing_round"
...
usage() {
  cat <<'USAGE'
Usage: bash scripts/run_lightweight_context_cueing_round.sh [options]
...
"${PYTHON_BIN}" scripts/lightweight_context_cueing_round.py \
