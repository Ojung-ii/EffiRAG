...
VARIANTS_CSV="champion_reconfirm,corridor_grouped_flat,path_structured_render,role_tagged_compact_render,evidence_first_prompt,path_structured_evidence_first"
N_SAMPLES="1000"
QA_ROOT="data/qa"
CORPUS_ROOT="/home/ojungii/HippoRAG2/dataset"
EFFIRAG_OUTPUT_ROOT="outputs/retrieval_metric_hotpot_2wiki_round_rerun_strict"
OUTPUT_ROOT="outputs/context_interface_abgf_round"
...
usage() {
  cat <<'USAGE'
Usage: bash scripts/run_context_interface_abgf_round.sh [options]
...
"${PYTHON_BIN}" scripts/context_interface_abgf_round.py \
