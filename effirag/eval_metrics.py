...
def build_lightweight_context_cueing_metric_registry() -> MetricRegistry:
    specs = [
        MetricSpec(
            name="recall_at_1",
            display_name="R@1",
        ...
        MetricSpec(
            name="recall_at_1_delta",
            display_name="ΔR@1",
            group="Retrieval Invariance Table",
            description="Recall@1 delta vs champion_reconfirm.",
            higher_is_better=False,
            fmt=".6f",
            source_level="diagnostic",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="recall_at_5_delta",
            display_name="ΔR@5",
            group="Retrieval Invariance Table",
            description="Recall@5 delta vs champion_reconfirm.",
            higher_is_better=False,
            fmt=".6f",
            source_level="diagnostic",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="recall_at_10_delta",
            display_name="ΔR@10",
            group="Retrieval Invariance Table",
            description="Recall@10 delta vs champion_reconfirm.",
            higher_is_better=False,
            fmt=".6f",
            source_level="diagnostic",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="retrieval_invariance_pass",
            display_name="pass/fail",
            group="Retrieval Invariance Table",
            description="Whether R@1/R@5/R@10 are invariant vs champion_reconfirm.",
            higher_is_better=True,
            fmt="",
            source_level="diagnostic",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="cueing_variant",
            display_name="cueing_variant",
            group="Cueing Variant Table",
            description="Cueing variant name.",
            higher_is_better=True,
            fmt="",
            source_level="context",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="role_prefix_activation_rate",
            display_name="role_prefix_activation_rate",
            group="Cueing Variant Table",
            description="Share of queries where minimal role prefix cue was applied.",
            higher_is_better=True,
            fmt=".4f",
            source_level="context",
            is_diagnostic=True,
        ...
        MetricSpec(
            ...
            display_name="role_unknown_rate",
            group="Cueing Variant Table",
            description="Average unknown role rate for role-based cueing.",
            higher_is_better=False,
            fmt=".4f",
            source_level="context",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="source_role_hint_activation_rate",
            display_name="source_role_hint_activation_rate",
            group="Cueing Variant Table",
            description="Share of queries where inline source-role hint cue was applied.",
            higher_is_better=True,
            fmt=".4f",
            source_level="context",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="duplicated_title_reduction_rate",
            display_name="duplicated_title_reduction_rate",
            group="Cueing Variant Table",
            description="Relative reduction of repeated title mentions in rendered context.",
            higher_is_better=True,
            fmt=".4f",
            source_level="context",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="unique_title_count",
            display_name="unique_title_count",
            group="Cueing Variant Table",
            description="Average number of unique titles represented in rendered context.",
            higher_is_better=True,
            fmt=".2f",
            source_level="context",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="title_repetition_reduction",
            display_name="title_repetition_reduction",
            group="Cueing Variant Table",
            description="Reduction ratio from naive per-sentence title repetition.",
            higher_is_better=True,
            fmt=".4f",
            source_level="context",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="separator_activation_rate",
            display_name="separator_activation_rate",
            group="Cueing Variant Table",
            description="Share of rendered lines using separator/bullet cueing.",
            higher_is_better=True,
            fmt=".4f",
            source_level="context",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="reorder_activation_rate",
            display_name="reorder_activation_rate",
            group="Cueing Variant Table",
            description="Share of queries where query-aware soft reordering changed order.",
            higher_is_better=True,
            fmt=".4f",
            source_level="context",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="avg_rank_shift",
            display_name="avg_rank_shift",
            group="Cueing Variant Table",
            description="Average absolute rank shift after query-aware soft ordering.",
            higher_is_better=False,
            fmt=".4f",
            source_level="diagnostic",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="max_rank_shift",
            display_name="max_rank_shift",
            group="Cueing Variant Table",
            description="Maximum absolute rank shift after query-aware soft ordering.",
            higher_is_better=False,
            fmt=".4f",
            source_level="diagnostic",
            is_diagnostic=True,
        ...
        MetricSpec(
            ...
            display_name="qa_utilization_changed_rate",
            group="Diagnostic Metrics",
            description="Prediction rewrite changed rate (must remain 0).",
            higher_is_better=False,
            fmt=".4f",
            source_level="diagnostic",
            is_diagnostic=True,
...
def build_prompt_interface_bridge_metric_registry() -> MetricRegistry:
    registry = build_light_separator_lockin_metric_registry()
    for spec in [
        MetricSpec(
            name="answer_length_avg",
            display_name="answer_length_avg",
            group="Main QA Table",
            description="Average prediction token length.",
            higher_is_better=False,
            fmt=".2f",
            source_level="generation",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="exact_answer_format_violation_rate",
            display_name="exact_answer_format_violation_rate",
            group="Format Violation Table",
            description="Rate of outputs violating compact final-answer format.",
            higher_is_better=False,
            fmt=".4f",
            source_level="diagnostic",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="reasoning_output_violation_rate",
            display_name="reasoning_output_violation_rate",
            group="Format Violation Table",
            description="Rate of outputs containing explicit reasoning traces.",
            higher_is_better=False,
            fmt=".4f",
            source_level="diagnostic",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="think_tag_violation_rate",
            display_name="think_tag_violation_rate",
            group="Format Violation Table",
            description="Rate of outputs containing <think> tags.",
            higher_is_better=False,
            fmt=".4f",
            source_level="diagnostic",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="format_violation_rate",
            display_name="format_violation_rate",
            group="Format Violation Table",
            description="Combined format-violation rate.",
            higher_is_better=False,
            fmt=".4f",
            source_level="diagnostic",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="added_instruction",
            display_name="added_instruction",
            group="Prompt Variant Table",
            description="Short description of added instruction for each prompt variant.",
            higher_is_better=True,
            fmt="",
            source_level="generation",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="one_shot_enabled",
            display_name="one_shot_enabled",
            group="Prompt Variant Table",
            description="Whether one-shot bridge example is included.",
            higher_is_better=True,
            fmt=".0f",
            source_level="generation",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="title_grounded_format_enabled",
            display_name="title_grounded_format_enabled",
            group="Prompt Variant Table",
            description="Whether compact title-grounded render format is enabled.",
            higher_is_better=True,
            fmt=".0f",
            source_level="context",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="final_answer_only",
            display_name="final_answer_only",
            group="Prompt Variant Table",
            description="Whether final-answer-only output is required.",
            higher_is_better=True,
            fmt=".0f",
            source_level="generation",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="reasoning_forbidden",
            display_name="reasoning_forbidden",
            group="Prompt Variant Table",
            description="Whether explicit reasoning output is forbidden.",
            higher_is_better=True,
            fmt=".0f",
            source_level="generation",
            is_diagnostic=True,
        ...
        MetricSpec(
            name="avg_context_tokens",
            display_name="avg_context_tokens",
            group="Context Efficiency Table",
            description="Average rendered context tokens.",
            higher_is_better=False,
            fmt=".1f",
            source_level="context",
        ...
        MetricSpec(
            ...
            display_name="median_context_tokens",
            group="Context Efficiency Table",
            description="Median rendered context tokens.",
            higher_is_better=False,
            fmt=".1f",
            source_level="context",
        ),
        MetricSpec(
            ...
            display_name="p90_context_tokens",
            group="Context Efficiency Table",
            description="P90 rendered context tokens.",
            higher_is_better=False,
            fmt=".1f",
            source_level="context",
        ),
        MetricSpec(
            ...
            display_name="answer_token_density",
            group="Context Efficiency Table",
            description="Answer-surface token density in rendered context.",
            higher_is_better=True,
            fmt=".4f",
            source_level="context",
        ),
        MetricSpec(
            ...
            display_name="sf_token_density",
            group="Context Efficiency Table",
            description="Supporting-fact token density in rendered context.",
            higher_is_better=True,
            fmt=".4f",
            source_level="context",
        ),
        MetricSpec(
            ...
            display_name="F1_per_1k_context_tokens",
            group="Context Efficiency Table",
            description="F1 normalized by avg context tokens.",
            higher_is_better=True,
            fmt=".4f",
            source_level="efficiency",
            is_proxy=True,
        ...
        MetricSpec(
            ...
            display_name="avg_context_tokens_delta",
            group="Context Efficiency Table",
            description="Average context token delta vs baseline variant.",
            higher_is_better=False,
            fmt=".2f",
            source_level="diagnostic",
            is_diagnostic=True,
