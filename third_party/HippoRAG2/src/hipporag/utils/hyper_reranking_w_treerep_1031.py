...
class HyperbolicEmbedder:
    def __init__(self, hr_instance, embed_dim=64, curvature=1.0, device="cpu",
                 use_simple_struct_feats: bool=True, struct_feat_scale: float=0.2):
        ...
        # 비학습형 Hyperbolic Smoothing Layer
        ...
        # ★ 완전 동결 (비학습형)
        self.hgnn_fusion.eval()
        for p in self.hgnn_fusion.parameters():
...
class HyperReranker:
    ...
    def rerank_with_structure(self, query_graph: Optional[ig.Graph],
                              ...
                              enable_hgnn_fusion: bool=False) -> Tuple[List[int], List[float]]:
